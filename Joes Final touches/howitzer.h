...
public:
   ...
   // meter position constructor
   Howitzer(double x, double y)
      : muzzleVelocity(DEFAULT_MUZZLE_VELOCITY), elevation(45.0)
   {
   ...
   void setElevation(double amtRadians) {
      elevation.setRadians(amtRadians);
   }
